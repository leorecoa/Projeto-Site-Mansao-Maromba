    ...
    items: [
      {
        ...
        answer:
          'O prazo de entrega varia de acordo com a sua região e a forma de envio escolhida. Você pode simular o prazo e o valor do frete no carrinho de compras antes de finalizar o pedido.',
      },
      {
        question: 'Como rastrear meu pedido?',
        answer:
          'Assim que seu pedido for enviado, você receberá um e-mail com o código de rastreio. Você também pode acompanhar o status do seu pedido na área "Minha Conta" em nosso site.',
      },
      {
        question: 'Posso alterar meu endereço de entrega?',
        answer:
          'Se o pedido ainda não tiver sido enviado, entre em contato conosco imediatamente através do nosso suporte. Caso já tenha sido despachado, não será possível alterar o endereço.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          'Aceitamos pagamentos via Cartão de Crédito (em até 12x), PIX (com aprovação imediata) e Boleto Bancário.',
      },
      {
        question: 'É seguro comprar no site?',
        answer:
          'Sim! Nosso site utiliza tecnologia de criptografia SSL para proteger seus dados. Além disso, não armazenamos os dados do seu cartão de crédito, o processamento é feito diretamente pela operadora de pagamentos.',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        answer:
          'Você tem até 7 dias corridos após o recebimento para solicitar a troca ou devolução por arrependimento. Em caso de defeito, o prazo é de 30 dias. Entre em contato com nosso suporte para iniciar o processo.',
      },
      {
        question: 'Recebi um produto errado ou danificado, o que fazer?',
        answer:
          'Pedimos desculpas pelo inconveniente! Por favor, entre em contato conosco enviando fotos do produto recebido para que possamos resolver o problema o mais rápido possível.',
      },
    ],
  },
];

...
const ALLOWED_MIME_TYPES = (
  import.meta.env.VITE_PRODUCTS_ALLOWED_MIME_TYPES || 'image/jpeg,image/png,image/webp,image/gif'
)
  .split(',')
    ...
    <div className="min-h-screen bg-black pt-24 pb-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <form
          ...
          className="bg-zinc-900 p-6 rounded-xl border border-white/10 space-y-6"
        >
          ...
          <div className="text-center text-xs text-gray-400">
            <p>
              Bucket: <span className="text-yellow-400">{PRODUCTS_BUCKET}</span>
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                {...register('category_id', { required: 'Categoria e obrigatoria' })}
                className="w-full bg-black/50 border border-white/10 rounded-lg p-3 text-white focus:border-yellow-400 outline-none"
              >
            ...
            <div>
              ...
              <input
                type="number"
                step="0.01"
                {...register('price', { required: 'Preco e obrigatorio', min: 0 })}
                className="w-full bg-black/50 border border-white/10 rounded-lg p-3 text-white focus:border-yellow-400 outline-none"
              />
            </div>
            <div>
              ...
              <input
                type="number"
                {...register('stock_quantity', { required: 'Estoque e obrigatorio', min: 0 })}
                className="w-full bg-black/50 border border-white/10 rounded-lg p-3 text-white focus:border-yellow-400 outline-none"
              />
            </div>
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                rows={4}
                className="w-full bg-black/50 border border-white/10 rounded-lg p-3 text-white focus:border-yellow-400 outline-none resize-none"
              />
            </div>
          </div>

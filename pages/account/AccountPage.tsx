      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-2 sm:flex sm:gap-4 mb-8 border-b border-white/10">
          <button
            ...
            className={`flex items-center justify-center sm:justify-start gap-2 px-3 sm:px-4 py-3 text-sm font-medium transition-colors relative ${
          ...
          <button
            ...
            className={`flex items-center justify-center sm:justify-start gap-2 px-3 sm:px-4 py-3 text-sm font-medium transition-colors relative ${
              activeTab === 'orders' ? 'text-yellow-400' : 'text-gray-400 hover:text-white'
            }`}
          >

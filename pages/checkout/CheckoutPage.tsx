                            ...
                            {cart.map(item => (
                                <div key={item.id} className="flex gap-4">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-gray-400 text-xs mt-1">{item.quantity}x {formatCurrency(item.price)}</p>
                                    </div>
                                    <p className="text-white font-bold text-sm">{formatCurrency(item.price * item.quantity)}</p>
                                </div>
                            ))}
                        </div>

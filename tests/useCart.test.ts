...
describe('useCart Hook', () => {
  ...
  it('deve limpar todo o carrinho', () => {
    ...
    act(() => {
      result.current.addToCart(createProduct({ id: '1', price: 50 }));
      result.current.addToCart(createProduct({ id: '2', price: 50 }));
    });
  ...
  it('deve calcular o total corretamente com múltiplos itens', () => {
    ...
    act(() => {
      result.current.addToCart(createProduct({ id: '1', price: 100 }));
      result.current.addToCart(createProduct({ id: '1', price: 100 }));
      result.current.addToCart(createProduct({ id: '2', price: 50 }));
    });

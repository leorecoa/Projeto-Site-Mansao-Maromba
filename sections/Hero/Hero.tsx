    ...
    <section id="hero" className="relative min-h-screen w-full flex flex-col items-center justify-center overflow-hidden bg-[#020202]">
      ...
      <div className="container mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center z-10 relative">
        <div key={activeProduct.id} className="flex flex-col items-start gap-10 order-2 lg:order-1 text-reveal">
          ...
          <h1 className="text-6xl md:text-[9rem] font-syncopate font-bold leading-[0.8] tracking-tighter">
            {activeProduct.name.split(' ').map((word, i) => (
              <span 
                ...
                style={{
                  color: i === 0 ? 'white' : activeProduct.theme.primary,
                  textShadow: `
                    0 0 6px ${activeProduct.theme.primary},
                    0 0 15px ${activeProduct.theme.glow},
                    -1px -1px 3px rgba(0,0,0,0.6),
                    1px 1px 3px rgba(0,0,0,0.6),
                    2px -2px 6px ${activeProduct.theme.primary}33,
                    -2px 2px 6px ${activeProduct.theme.primary}33
                  `,
          ...
          <p className="max-w-md text-2xl text-gray-400 font-medium leading-tight border-l-8 pl-10" style={{ borderColor: activeProduct.theme.primary }}>
          ...
          <div className="flex flex-wrap items-center gap-6 mt-6">
            <button 
              ...
              style={{ 
                ...
                '--glow-color': activeProduct.theme.glow,
        ...
        <div className="relative order-1 lg:order-2 flex justify-center items-center h-[550px] md:h-[850px] perspective-stage">
          ...
          <div className="relative w-full h-full flex items-center justify-center transform-gpu">
            {products.map((product, index) => {
              ...
              let rotateY = '0deg';
              let zIndex = 0;
              let filter = 'blur(20px) grayscale(70%)';

              if (isCenter) {
                translateX = '0%';
                translateZ = '400px';
                opacity = 1;
                scale = isTransitioning ? 1.4 : 1.15;
                zIndex = 50;
              ...
              return (
                <div 
                  ...
                  style={{ 
                    ...
                    opacity,
                    zIndex,
                    filter: !isCenter ? filter : undefined,
      ...
      <div className="absolute bottom-16 flex items-end gap-8 z-30">
        {products.map((_, i) => (
          ...
          >
            ...
            <div
              className="transition-all duration-[0.8s] rounded-full"
              style={{ 
                ...
                transition: `height 0.8s, width 0.8s, background-color 0.8s, box-shadow 0.8s, transform 0.8s`,
              }}
            />
          </button>
        ))}

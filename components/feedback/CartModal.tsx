...
const CartModal: React.FC<CartModalProps> = ({ activeTheme, onCheckout }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      <div className="relative w-full max-w-md bg-[#0a0a0a] h-full shadow-2xl flex flex-col border-l border-white/5">
        {/* Header */}
        ...
        <div className="flex-grow overflow-y-auto p-6 space-y-6">
          {items.length === 0 ? (
            ...
            items.map(item => (
              <div
                key={item.id}
                className="flex gap-4 glass-card p-4 rounded-2xl relative overflow-hidden"
              >
                <div
                ...
                <button
                  ...
                  className="absolute top-2 right-2 text-red-500/40 hover:text-red-500"
                >
                  <Trash2 size={16} />
                </button>
              </div>
        ...
        {items.length > 0 && (
          <div className="p-6 bg-white/5 border-t border-white/5 space-y-4">
            <div className="flex justify-between items-center">
              ...
              <span className="text-3xl font-syncopate font-bold">
            ...
            <button
              onClick={onCheckout}
              className="w-full py-5 rounded-2xl font-bold flex items-center justify-center gap-3 active:scale-95"
              style={{

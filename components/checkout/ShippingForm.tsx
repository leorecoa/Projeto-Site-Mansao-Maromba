    ...
    <div className="bg-zinc-900 p-6 rounded-xl border border-white/10 space-y-4 mt-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="col-span-1">
          <label htmlFor="shipping-zip" className="block text-sm text-gray-400 mb-1">
            CEP
          </label>
          <div className="relative">
            <input
              ...
              className={`w-full bg-black/50 border rounded-lg p-3 text-white focus:border-yellow-400 outline-none transition-colors disabled:opacity-50 ${
                errors.shipping?.zip ? 'border-red-500' : 'border-white/10'
              }`}
        ...
        <div className="col-span-2">
          <label htmlFor="shipping-city" className="block text-sm text-gray-400 mb-1">
            Cidade
          </label>
          <input
            id="shipping-city"
      ...
      <div className="grid grid-cols-4 gap-4">
        <div className="col-span-3">
          <label htmlFor="shipping-street" className="block text-sm text-gray-400 mb-1">
            Rua
          </label>
          <input
            id="shipping-street"
            ...
            className={`w-full bg-black/50 border rounded-lg p-3 text-white focus:border-yellow-400 outline-none transition-colors disabled:opacity-50 ${
              errors.shipping?.street ? 'border-red-500' : 'border-white/10'
            }`}
          />
        ...
        <div className="col-span-1">
          <label htmlFor="shipping-number" className="block text-sm text-gray-400 mb-1">
            Número
          </label>
          <input
            id="shipping-number"
            ...
            className={`w-full bg-black/50 border rounded-lg p-3 text-white focus:border-yellow-400 outline-none transition-colors disabled:opacity-50 ${
              errors.shipping?.number ? 'border-red-500' : 'border-white/10'
            }`}
          />
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label htmlFor="shipping-neighborhood" className="block text-sm text-gray-400 mb-1">
            Bairro
          </label>
          <input
            ...
            className={`w-full bg-black/50 border rounded-lg p-3 text-white focus:border-yellow-400 outline-none transition-colors disabled:opacity-50 ${
              errors.shipping?.neighborhood ? 'border-red-500' : 'border-white/10'
            }`}
          />
          {errors.shipping?.neighborhood && (
            <span className="text-xs text-red-500 mt-1">
              {errors.shipping.neighborhood.message}
            </span>
          )}
        </div>
        <div>
          <label htmlFor="shipping-state" className="block text-sm text-gray-400 mb-1">
            Estado (UF)
          </label>
          <input
            id="shipping-state"

...
describe('useCep Hook', () => {
    ...
    it('deve chamar setError em caso de falha na requisição da API', async () => {
        ...
        expect(mockSetError).toHaveBeenCalledWith('shipping.zip', { type: 'manual', message: 'Erro ao buscar CEP' })
    })
    ...
    it('deve preencher os campos de endereço em caso de sucesso', async () => {
        ...
        expect(mockSetValue).toHaveBeenCalledWith('shipping.street', 'Rua Teste', { shouldValidate: true })

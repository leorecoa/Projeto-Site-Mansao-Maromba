  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-black">
      ...
      <div
        ...
        style={{
          backgroundColor: `${LOGIN_PALETTE[1]}33`,
      ...
      <div
        ...
        style={{
          backgroundColor: `${LOGIN_PALETTE[2]}33`,
      ...
      <div
        ...
        style={{
          backgroundColor: `${LOGIN_PALETTE[3]}22`,
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h1
              ...
              style={{
                textShadow: '0 0 14px rgba(250, 204, 21, 0.55), 0 0 28px rgba(34, 211, 238, 0.25)',
              }}
            >
              Mansão Maromba
            </h1>
          ...
          <div className="relative glass-card rounded-2xl p-5 sm:p-8 border border-yellow-400/20 shadow-2xl backdrop-blur-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
              ...
              <button
                ...
                style={{
                  boxShadow: '0 0 20px rgba(250, 204, 21, 0.25), 0 0 34px rgba(34, 211, 238, 0.12)',
                }}
              >
            ...
            <button
              ...
              style={{
                boxShadow: '0 0 16px rgba(236, 72, 153, 0.18), 0 0 26px rgba(34, 211, 238, 0.14)',
              }}
            >
